...
INSERT INTO `nationalities` (`id`, `alpha_2_code`, `alpha_3_code`, `en_short_name`, `nationality`, `country_id`) VALUES
...
(53, 'CI', 'CIV', 'Côte dIvoire', 'Ivorian', 53),
...
(115, 'KP', 'PRK', 'Korea (Democratic Peoples Republic of)', 'North Korean', 115),
...
(119, 'LA', 'LAO', 'Lao Peoples Democratic Republic', 'Lao, Laotian', 119),
